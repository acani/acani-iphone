...
//	int height = 22.0f;
	...
	// Temporary Array to hold Age options
	NSMutableArray *agesArray = [[NSMutableArray alloc] initWithCapacity:129];
	[agesArray insertObject:@"Do not Show" atIndex:0];
	for(int i=1; i<=128; i++){
		NSString *numberString= [[NSString alloc ] initWithFormat:@"%d", i];
		[agesArray insertObject:numberString atIndex:i];
		[numberString release];
	}
	
	// Temporary array to hold Weight options
	NSMutableArray *weightsArray = [[NSMutableArray alloc] initWithCapacity:401];
	[weightsArray insertObject:@"Do not Show" atIndex:0];
	for(int i=1; i<=400; i++){
		NSString *numberString= [[NSString alloc ] initWithFormat:@"%d", i];
		[weightsArray insertObject:numberString atIndex:i];
		[numberString release];
	}
	...
	pickerOptions = [[NSArray alloc] initWithObjects:
					 [[NSArray alloc] initWithObjects: // section: 0
					  ...
					  [[NSArray alloc] initWithObjects: agesArray, nil],
					  [[NSArray alloc] initWithObjects:
					  ...
					  [[NSArray alloc] initWithObjects: weightsArray, nil],					  
					  [[NSArray alloc] initWithObjects:
