Feature: register with Facebook
  ...
  Background:
    Given I don't have an acani account

  # Condense the following two scenarios into one

  Scenario: not logged into Facebook
  ...
  Scenario: already logged into Facebook; I allow acani
